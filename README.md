...
only managed to get some data from weather on console log to show on browser. tried many ways but now the UV section for information is not working so cannot get this & the temperature wont load.
